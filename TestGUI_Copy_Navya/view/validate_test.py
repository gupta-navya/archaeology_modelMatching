...
class ValidateMatchingWindow(QDialog,OpenImageMixin,PlyWindowMixin):
    ...
    def init_general_information(self):
        ...
        self.total_finds_value.setText("15")
        self.total_models_value.setText("10")
        self.auto_matches_value.setText("10")

        self.validated_value.setText("0")
        self.validation_progress.setValue(0)
        self.validation_progress.setMaximum(10)
        self.max_check_value = 0

        self.context_value.setText("N-38-478130-4419430-88")

    def display_general_information(self,auto_matches_value):
    ...
    def display_frame_color(self, frame_id: int, color: str):
