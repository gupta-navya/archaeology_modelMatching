...
class SelectMethodWindow(QDialog,):
    def __init__(self, parent, presenter):
        ...
        self.init_widgets()
        uic.loadUi("TestGUI_Copy/view/ui_files/SelectMethod.ui", self)
...
class SelectAlgorithmWindow(QDialog):
    def __init__(self, parent, presenter):
        super().__init__(parent)
        self.init_widgets()
        uic.loadUi("TestGUI_Copy/view/ui_files/SelectAlgorithm.ui", self)
        self.presenter = presenter
...
class LoadingWindow(QDialog):
    def __init__(self, parent, presenter, total_features = 60):
        ...
        super().__init__(parent)
        uic.loadUi("TestGUI_Copy/view/ui_files/Loading.ui", self)
        self.presenter = presenter
